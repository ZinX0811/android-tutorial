...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // update std
        contextLauncher = registerForActivityResult(
        ...
        studentAdapter =
            StudentAdapter(students, this@MainActivity, parentView, contextLauncher, studentDao)
        ...
        optionLauncher = registerForActivityResult(
            ActivityResultContracts.StartActivityForResult(),
            { it: ActivityResult ->
                if (it.resultCode == RESULT_OK) {
